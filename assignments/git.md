Git Assignment: PDS Spring 2014
-------------------------------
...
3. Write program files with your unix commands used to find the answers in the previous assignment, one file per question. Similarly, make one file per response.

For instance, you may have: question_1.sh and question_1_response.txt, containing the script and response for the first question.
